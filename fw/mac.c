...
static bool handle_irq(void)
{
	...
	// We are supposed to initiate the attack in RX_ON state. However I cannot find the entry.
	// That's why I chose here as the entry: When a packet has been received, the device will go to RX_ON state.
	// initiate_attack(&stat);
